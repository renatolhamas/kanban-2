---
description: Analisa itens "TO BE DECIDED" em uma story e recomenda opções.
---

# Workflow: Análise de TBDs (To Be Decided)
...
**Uso:** `/tbd [caminho_da_story]` ou apenas `/tbd` para o arquivo aberto.
