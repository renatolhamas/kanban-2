...
| **Webhooks**      | Evo GO (https://evogo.renatop.com.br/swagger/index.html (Ref: docs/evogo/docs.evogo.doc.json)) | Go language high-performance WhatsApp gateway, HMAC-SHA256 validation | WhatsApp Cloud API (stricter rate limits, approval process)                                         |
