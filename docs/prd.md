...
| Feature | Descrição | Aceitação |
|---------|-----------|-----------|
| **CRUD de Kanbans** | Criar, ler, atualizar, deletar pipelines com reordenação | Interface com drag-drop ou botões Antes/Depois |
...
- [ ] Supabase schema (tables, RLS, Auth)
- [ ] Componentes UI base (Tailwind tokens, layout shell)
...
### Sprint 5-6: Kanban & Chat
- [ ] Home page (Kanban board layout)
- [ ] Drag-and-drop (React Beautiful DnD ou similar)
- [ ] Chat modal (messaging UI)
- [ ] Evolution API pairing (QR code)

### Sprint 7-8: CRUD Features
- [ ] Contacts CRUD
- [ ] Automatic Messages CRUD
- [ ] Kanbans CRUD
- [ ] Settings pages

### Sprint 9-10: Real-time & Webhooks
- [ ] Supabase Real-time subscriptions
- [ ] Evolution API webhook listener
- [ ] Message sync (sent/received)
- [ ] Auto-registration de contatos

### Sprint 11-12: QA & Polish
- [ ] E2E testing (Playwright)
- [ ] Performance optimization
- [ ] Security audit (CodeRabbit)
- [ ] Documentation

### Post-MVP
- [ ] Beta launch (50 users)
- [ ] Feedback incorporation
- [ ] Roadmap prioritization (Fase 2+)
