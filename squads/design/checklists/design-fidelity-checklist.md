...
- [ ] Tipo de componente: ******\_****** (button, input, card, modal, etc.)
- [ ] Variantes: ******\_****** (primary, secondary, outline, etc.)
- [ ] Estados: ******\_****** (default, hover, focus, disabled, etc.)
...
_Checklist v1.0 - Baseado em design-tokens-spec.yaml v1.0.0_
