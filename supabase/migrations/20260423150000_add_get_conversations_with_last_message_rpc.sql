-- Migration: Add RPC for fetching conversations with last message preview (Story 5.4)
-- Purpose: Implement optimized correlated subquery for Kanban board display
...
BEGIN
  ...
  SELECT 
    ...
    0 AS unread_count -- Placeholder for Story 5.2.1
...
COMMENT ON FUNCTION public.get_conversations_with_last_message IS 'Returns active conversations for a kanban board with their most recent message preview data using an optimized correlated subquery.';
